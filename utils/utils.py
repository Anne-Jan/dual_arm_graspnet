...
def get_control_point_tensor(batch_size, use_torch=True, device="cpu", dual_grasp=False):
    """
...
def control_points_from_grasps(grasps, output_type='cp', pc=None, color = (0, 1, 0,), scale=0.2):
